...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.0.0-SNAPSHOT/gradle-plugin/reference/htmlsingle/#aot)
...
```
$ docker run --rm kc-spring-native:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/kc-spring-native
```
